...
class _AIConfigurationPageState extends State<AIConfigurationPage> {
  ...
  void initState() {
    super.initState();
    _isConfigured = AIAnalysisService.isConfigured;
    if (_isConfigured) {
      _apiKeyController.text = 'sk-proj-...***...***'; // Masked key
    }
  }
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'sk-proj-...',
                      prefixIcon:
                          const Icon(Icons.key, color: Color(0xFF3498DB)),
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          if (_apiKeyController.text.isNotEmpty) {
                            AIAnalysisService.setApiKey(_apiKeyController.text);
                            setState(() {
                              _isConfigured = AIAnalysisService.isConfigured;
                            });
