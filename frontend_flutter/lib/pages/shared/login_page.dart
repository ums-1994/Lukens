...
class _LoginPageState extends State<LoginPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    // IMPORTANT: precacheImage uses context -> schedule after first frame
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                // Google (custom icon button; SignInButton mini not supported)
                _buildSocialButton(
                  FaIcon(
                ...
                _buildSocialButton(
                  FaIcon(FontAwesomeIcons.windows, color: Color(0xFF0078D4), size: 22),
                ),
                const SizedBox(width: 16),
                _buildSocialButton(
                  FaIcon(FontAwesomeIcons.building, color: Color(0xFFE9293A), size: 22),
                ),
              ],
            ),
            const SizedBox(height: 24),
