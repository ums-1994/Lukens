...
class AppSpacing {
  static const EdgeInsets sidebarHeaderPadding = EdgeInsets.symmetric(horizontal: 16, vertical: 12);
  static const EdgeInsets sidebarItemPadding = EdgeInsets.symmetric(horizontal: 12, vertical: 8);
}
