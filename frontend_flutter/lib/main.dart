...
import 'pages/shared/calendar_view_page.dart';
...
import 'shared/widgets/onboarding_tour.dart';
import 'api.dart';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/calendar': (context) => const CalendarViewPage(),
          '/compose': (context) {
          ...
          '/client-management': (context) => const ClientManagementPage(),
